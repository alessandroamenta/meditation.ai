    ...
    <>
      <section className="space-y-6 pb-12 pt-16 lg:py-28">
        <div className="container flex max-w-[64rem] flex-col items-center gap-5 text-center">
          ...
          >
            Achieve mental clarity and relaxation with AI-generated guided meditations for any mind, any mood, any goal.
          </p>
      ...
      >
        <div className="container mx-auto">
            <h2 className="text-center text-sm font-semibold uppercase">AI generated meditations.<br />Powered by</h2>
...
const features = [
  ...
  },
  {
    ...
    icon: (
      <svg className="h-10 w-auto" viewBox="0 0 46 32" xmlns="http://www.w3.org/2000/svg" width="46" height="32">
        <path fill="currentColor" d="M32.73 0h-6.945L38.45 32h6.945L32.73 0ZM12.665 0 0 32h7.082l2.59-6.72h13.25l2.59 6.72h7.082L19.929 0h-7.264Zm-.702 19.337 4.334-11.246 4.334 11.246h-8.668Z" fillRule="evenodd"></path>
      </svg>
    ),
  },
  {
    ...
    icon: (
      ...
      <line x1="128" y1="32" x2="128" y2="224" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="20"></line>
      <line x1="192" y1="32" x2="192" y2="224" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="20"></line>
      </svg>
    ),
  },
]